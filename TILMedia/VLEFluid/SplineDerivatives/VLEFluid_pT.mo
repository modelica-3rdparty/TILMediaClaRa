...
equation
  ...
  (q,cp,cv,beta,kappa,drhodp_hxi,drhodh_pxi,drhodxi_ph,w,gamma) =
    TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.additionalProperties_phxi(
    p,
    h,
    xi,
    vleFluidPointer);
  ...
  (VLE.d_l,VLE.h_l,VLE.p_l,VLE.s_l,VLE.T_l,VLE.xi_l,VLE.d_v,VLE.h_v,VLE.p_v,VLE.s_v,
    VLE.T_v,VLE.xi_v) =TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.VLEProperties_phxi(
    p,
    -1,
    xi,
    vleFluidPointer);
 ...
 transp.lambda,
 transp.eta,
 transp.sigma) =TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.transportPropertyRecord_phxi(
      p,
      h,
      xi,
      vleFluidPointer);
  ...
  if computeVLEAdditionalProperties then
    ...
    (VLEAdditional.cp_l,VLEAdditional.beta_l,VLEAdditional.kappa_l,
      ...
      TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.VLEAdditionalProperties_phxi(
      p,
      -1,
      xi,
      vleFluidPointer);
  ...
  if computeVLETransportProperties then
    ...
    (VLETransp.Pr_l,VLETransp.Pr_v,VLETransp.lambda_l,VLETransp.lambda_v,
      ...
      TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.VLETransportPropertyRecord_phxi(
      p,
      -1,
      xi,
      vleFluidPointer);
