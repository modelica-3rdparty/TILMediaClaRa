...
model VLEFluid_ps "Compressible fluid model with p, s and xi as independent variables"
...
equation
  ...
  d =TILMedia.VLEFluid.ObjectFunctions.density_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  h =TILMedia.VLEFluid.ObjectFunctions.specificEnthalpy_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  T =TILMedia.VLEFluid.ObjectFunctions.temperature_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
