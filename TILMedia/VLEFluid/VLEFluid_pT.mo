...
model VLEFluid_pT "Compressible fluid model with p, T and xi as independent variables"
...
equation
  ...
  d =TILMedia.VLEFluid.ObjectFunctions.density_pTxi(
    p,
    T,
    xi,
    vleFluidPointer);
  h =TILMedia.VLEFluid.ObjectFunctions.specificEnthalpy_pTxi(
    p,
    T,
    xi,
    vleFluidPointer);
  s =TILMedia.VLEFluid.ObjectFunctions.specificEntropy_pTxi(
    p,
    T,
    xi,
    vleFluidPointer);
  ...
  (VLE.d_l,VLE.h_l,VLE.p_l,VLE.s_l,VLE.T_l,VLE.xi_l,VLE.d_v,VLE.h_v,VLE.p_v,VLE.s_v,
    VLE.T_v,VLE.xi_v) =TILMedia.Internals.VLEFluid.AdditionalObjectFunctions.VLEProperties_phxi(
    p,
    -1,
    xi,
    vleFluidPointer);
