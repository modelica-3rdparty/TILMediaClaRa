...
model VLEFluid_dT "Compressible fluid model with d, T and xi as independent variables"
  extends TILMedia.BaseClasses.PartialVLEFluid_dT(vleFluidPointer=TILMedia.Internals.TILMediaExternalObject(
        ...
        vleFluidType.nc,
        0,
        getInstanceName()), M_i={TILMedia.VLEFluid.ObjectFunctions.molarMass_n(i - 1, vleFluidPointer) for i in 1:
        vleFluidType.nc});
protected
...
equation
  ...
  h =TILMedia.VLEFluid.ObjectFunctions.specificEnthalpy_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
  p =TILMedia.VLEFluid.ObjectFunctions.pressure_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
  s =TILMedia.VLEFluid.ObjectFunctions.specificEntropy_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
  ...
  (VLE.d_l,VLE.h_l,VLE.p_l,VLE.s_l,VLE.T_l,VLE.xi_l,VLE.d_v,VLE.h_v,VLE.p_v,VLE.s_v,
    VLE.T_v,VLE.xi_v) =TILMedia.Internals.VLEFluid.AdditionalObjectFunctions.VLEProperties_dTxi(
    -1,
    T,
    xi,
    vleFluidPointer);
