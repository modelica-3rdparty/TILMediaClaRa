...
equation
  ...
  d =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.density_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  h =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.specificEnthalpy_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  T =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.temperature_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
