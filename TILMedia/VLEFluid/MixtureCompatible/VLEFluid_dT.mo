...
equation
  ...
  h =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.specificEnthalpy_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
  p =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.pressure_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
  s =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.specificEntropy_dTxi(
    d,
    T,
    xi,
    vleFluidPointer);
