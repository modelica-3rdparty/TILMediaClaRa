...
model VLEFluid_ph
  ...
  extends TILMedia.BaseClasses.PartialVLEFluid_ph(vleFluidPointer=TILMedia.Internals.TILMediaExternalObject(
          "VLEFluid",
...
equation
  ...
  d =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.density_phxi(
    p,
    h,
    xi,
    vleFluidPointer);
  s =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.specificEntropy_phxi(
    p,
    h,
    xi,
    vleFluidPointer);
  T =TILMedia.VLEFluid.MixtureCompatible.ObjectFunctions.temperature_phxi(
    p,
    h,
    xi,
    vleFluidPointer);
