...
package VLEFluidObjectFunctions
  ...
  external "C" d = TILMedia_VLEFluid_Cached_density_phxi(
        ...
        h,
        xi, vleFluidPointer)
  annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_density_phxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
  ...
  external "C" TILMedia_VLEFluid_additionalProperties_dTxi(
        ...
        a,
        gamma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_additionalProperties_dTxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
  ...
  external "C" TILMedia_VLEFluid_additionalProperties_phxi(
        ...
        a,
        gamma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_additionalProperties_phxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_additionalProperties_psxi(
        ...
        a,
        gamma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_additionalProperties_psxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_additionalProperties_pTxi(
        ...
        a,
        gamma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_additionalProperties_pTxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_criticalDataRecord_xi(
        ...
        s,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_criticalDataRecord_xi(double*, void*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_molarMass_xi(double*,void*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  end molarMass_xi;
  ...
  external "C" TILMedia_VLEFluid_properties_dTxi(
        ...
        p,
        s)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_dTxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_dTxi;
  ...
  external "C" TILMedia_VLEFluid_properties_phxi(
        ...
        s,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_phxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_phxi;
  ...
  external "C" TILMedia_VLEFluid_properties_psxi(
        ...
        h,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_psxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_psxi;
  ...
  external "C" TILMedia_VLEFluid_properties_pTxi(
        ...
        h,
        s)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_pTxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_pTxi;
  ...
  external "C" TILMedia_VLEFluid_transportProperties_dTxi(
        ...
        eta,
        sigma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_transportProperties_dTxi(double, double, double*, void*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_transportProperties_phxi(
        ...
        eta,
        sigma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_transportProperties_phxi(double, double, double*, void*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_transportProperties_psxi(
        ...
        eta,
        sigma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_transportProperties_psxi(double, double, double*, void*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_transportProperties_pTxi(
        ...
        eta,
        sigma)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_transportProperties_pTxi(double, double, double*, void*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLETransportProperties_dTxi(
        ...
        eta_l,
        eta_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLETransportProperties_dTxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLETransportProperties_phxi(
        ...
        eta_l,
        eta_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLETransportProperties_phxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLETransportProperties_psxi(
        ...
        eta_l,
        eta_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLETransportProperties_psxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_Cached_phase_dTxi(
      ...
      xi, vleFluidPointer,
      phase)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_Cached_phase_dTxi(double, double, double*, void*, int*);", Library="TILMedia182ClaRa");
  end phase_dTxi;
  ...
  external "C" TILMedia_VLEFluid_Cached_phase_phxi(
        ...
        xi, vleFluidPointer,
        phase)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_Cached_phase_phxi(double, double, double*, void*, int*)", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end phase_phxi2;
  ...
  external "C" TILMedia_VLEFluid_VLEAdditionalProperties_dTxi(
    ...
    cp_l, beta_l, kappa_l,
    cp_v, beta_v, kappa_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEAdditionalProperties_dTxi(double, double, double*, void*,double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLEAdditionalProperties_phxi(
    ...
    cp_l, beta_l, kappa_l,
    cp_v, beta_v, kappa_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEAdditionalProperties_phxi(double, double, double*, void*,double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLEAdditionalProperties_psxi(
    ...
    cp_l, beta_l, kappa_l,
    cp_v, beta_v, kappa_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEAdditionalProperties_psxi(double, double, double*, void*,double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_VLEAdditionalProperties_pTxi(
    ...
    cp_l, beta_l, kappa_l,
    cp_v, beta_v, kappa_v)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEAdditionalProperties_pTxi(double, double, double*, void*,double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEProperties_dTxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*,
                double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  ...
  annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_triplePressure_n(int, void*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_tripleTemperature_n(int, void*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_cricondenbar_xi(
        ...
        s,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_cricondenbar_xi(double*, void*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  end cricondenbar_xi;
  ...
  external "C" TILMedia_VLEFluid_cricondentherm_xi(
        ...
        s,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_cricondentherm_xi(double*, void*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  external "C" TILMedia_VLEFluid_properties_pdxi(
        ...
        s,
        T)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_pdxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_pdxi;
  ...
  external "C" TILMedia_VLEFluid_meanDensity_phAhB(
        ...
        drhobar_dh2,
        onePhase)
    annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_meanDensity_phAhB(double, double*, double, double, void*, void*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
  ...
  external "C" TILMedia_VLEFluid_properties_Thxi(
        ...
        p,
        s)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_Thxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_Thxi;
  ...
  external "C" TILMedia_VLEFluid_properties_Tsxi(
        ...
        h,
        p)
  annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_properties_Tsxi(double, double, double*, void*, double*, double*, double*);", Library="TILMedia182ClaRa");
                                    annotation(Impure=false);
  end properties_Tsxi;
  ...
  package PureComponentDerivatives
    ...
    external "C" s = TILMedia_VLEFluid_Cached_specificEntropy_dTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEntropy_dTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEntropy_dTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" h = TILMedia_VLEFluid_Cached_specificEnthalpy_dTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEnthalpy_dTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_h = TILMedia_VLEFluid_Cached_der_specificEnthalpy_dTxi(
          ...
          der_T,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEnthalpy_dTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" p = TILMedia_VLEFluid_Cached_pressure_dTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_pressure_dTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_p = TILMedia_VLEFluid_Cached_der_pressure_dTxi(
          ...
          der_T,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_pressure_dTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" T = TILMedia_VLEFluid_Cached_temperature_psxi(
          ...
          s,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_temperature_psxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_T = TILMedia_VLEFluid_Cached_der_temperature_psxi(
          ...
          der_s,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_temperature_psxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" d = TILMedia_VLEFluid_Cached_density_psxi(
          ...
          s,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_density_psxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_d = TILMedia_VLEFluid_Cached_der_density_psxi(
          ...
          der_s,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_density_psxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" h = TILMedia_VLEFluid_Cached_specificEnthalpy_psxi(
          ...
          s,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEnthalpy_psxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_h = TILMedia_VLEFluid_Cached_der_specificEnthalpy_psxi(
          ...
          der_s,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEnthalpy_psxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" T = TILMedia_VLEFluid_Cached_temperature_phxi(
          ...
          h,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_temperature_phxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_T = TILMedia_VLEFluid_Cached_der_temperature_phxi(
          ...
          der_h,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_temperature_phxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" s = TILMedia_VLEFluid_Cached_specificEntropy_phxi(
          ...
          h,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEntropy_phxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_s = TILMedia_VLEFluid_Cached_der_specificEntropy_phxi(
          ...
          der_h,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEntropy_phxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" der_d = TILMedia_VLEFluid_Cached_der_density_phxi(
          ...
          der_h,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_density_phxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    end der_density_phxi;
    ...
    external "C" s = TILMedia_VLEFluid_Cached_specificEntropy_pTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEntropy_pTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_s = TILMedia_VLEFluid_Cached_der_specificEntropy_pTxi(
          ...
          der_T,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEntropy_pTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" d = TILMedia_VLEFluid_Cached_density_pTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_density_pTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_d = TILMedia_VLEFluid_Cached_der_density_pTxi(
          ...
          der_T,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_density_pTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    external "C" h = TILMedia_VLEFluid_Cached_specificEnthalpy_pTxi(
          ...
          T,
          xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_specificEnthalpy_pTxi(double, double, double*, void*);", Library="TILMedia182ClaRa");
    ...
    external "C" der_h = TILMedia_VLEFluid_Cached_der_specificEnthalpy_pTxi(
          ...
          der_T,
          der_xi, vleFluidPointer)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_VLEFluid_Cached_der_specificEnthalpy_pTxi(double, double, double*, double, double, double*, void*);", Library="TILMedia182ClaRa");
                                      annotation(Impure=false);
    ...
    annotation( Library="TILMedia182ClaRa",__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_VLEProperties_phxi(double, double, double*, void*,
    ...
    external "C" TILMedia_VLEFluid_der_transportProperties_phxi(
          ...
          der_eta,
          der_sigma)
    annotation( Library="TILMedia182ClaRa",__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_transportProperties_phxi(double, double, double*, void*, double, double, double*, double*, double*, double*, double*);");
                                      annotation(Impure=false);
    ...
    external "C" TILMedia_VLEFluid_der_additionalProperties_phxi(
          ...
          a,
          gamma)
    annotation( Library="TILMedia182ClaRa",__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_additionalProperties_phxi(double, double, double*, void*, double, double, double*, double*, double*, double*, double*, double*, double*
    ...
    external "C" TILMedia_VLEFluid_VLETransportProperties_phxi(
          ...
          eta_v)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLETransportProperties_phxi(double, double, double*, void*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
      annotation(Impure=false, derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_VLETransportPropertyRecord_phxi);
    end VLETransportPropertyRecord_phxi;
    ...
    external "C" TILMedia_VLEFluid_der_VLETransportProperties_phxi(
          ...
          der_eta_l,
          der_eta_v)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_VLETransportProperties_phxi(double, double, double*, void*, double, double, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
      annotation(Impure=false);
    ...
    external "C" TILMedia_VLEFluid_VLEAdditionalProperties_phxi(
      ...
      cp_v, beta_v, kappa_v)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_VLEAdditionalProperties_phxi(double, double, double*, void*,double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
      annotation(Impure=false, derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_VLEAdditionalProperties_phxi);
    end VLEAdditionalProperties_phxi;
    ...
    external "C" TILMedia_VLEFluid_der_VLEAdditionalProperties_phxi(
          ...
          der_beta_v,
          der_kappa_v)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_VLEAdditionalProperties_phxi(double, double, double*, void*, double, double, double*, double*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
      annotation(Impure=false);
    ...
    external "C" TILMedia_VLEFluid_meanDensity_phAhB(
          ...
          onePhase)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_meanDensity_phAhB(double, double*, double, double, void*, void*, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
      annotation(derivative(noDerivative=cache_A, noDerivative=cache_B)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_meanDensity_phAhB);
    end meanDensity_phAhB;
    ...
    external "C" TILMedia_VLEFluid_der_meanDensity_phAhB(
          ...
          der_drhobar_dh2,
          der_onePhase)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_VLEFluid_der_meanDensity_phAhB(double, double*, double, double, void*, void*, double, double*, double, double, double*, double*, double*, double*, double*);", Library="TILMedia182ClaRa");
    ...
    external"C" T_dew = TILMedia_VLEFluid_Cached_dewTemperature_pxi(
        ...
        vleFluidPointer) annotation (
          ...
          Include=
           ...
           Library="TILMedia182ClaRa");
      annotation(derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_dewTemperature_pxi);
    end dewTemperature_pxi;

    function der_dewTemperature_pxi
      extends TILMedia.BaseClasses.PartialVLEFluidObjectFunction;
      input SI.AbsolutePressure p "Pressure";
      input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
      input TILMedia.Internals.TILMediaExternalObject vleFluidPointer;
      input Real der_p "Pressure";
      input Real[:] der_xi "Mass fractions of the first nc-1 components";
      output Real der_T_dew "Temperature at dew point";
    ...
    external"C" T_bubble = TILMedia_VLEFluid_Cached_bubbleTemperature_pxi(
        ...
        vleFluidPointer) annotation (
          ...
          Include=
           ...
           Library="TILMedia182ClaRa");
      annotation(derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_bubbleTemperature_pxi);
    end bubbleTemperature_pxi;

    function der_bubbleTemperature_pxi
      extends TILMedia.BaseClasses.PartialVLEFluidObjectFunction;
      input SI.AbsolutePressure p "Pressure";
      input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
      input TILMedia.Internals.TILMediaExternalObject vleFluidPointer;
      input Real der_p "Pressure";
      input Real[:] der_xi "Mass fractions of the first nc-1 components";
      output Real der_T_bubble "Temperature at bubble point";
    ...
    external"C" p_dew = TILMedia_VLEFluid_Cached_dewPressure_Txi(
        ...
        vleFluidPointer) annotation (
          ...
          Include=
           ...
           Library="TILMedia182ClaRa");
      annotation(derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_dewPressure_Txi);
    end dewPressure_Txi;

    function der_dewPressure_Txi
      extends TILMedia.BaseClasses.PartialVLEFluidObjectFunction;
      input SI.Temperature T "Temperature";
      input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
      input TILMedia.Internals.TILMediaExternalObject vleFluidPointer;
      ...
      input Real[:] der_xi "Mass fractions of the first nc-1 components";
      output Real der_p_dew "Pressure at dew point";
    ...
    external"C" p_bubble = TILMedia_VLEFluid_Cached_bubblePressure_Txi(
        ...
        vleFluidPointer) annotation (
          ...
          Include=
           ...
           Library="TILMedia182ClaRa");
      annotation(derivative(noDerivative=vleFluidPointer)=TILMedia.Internals.VLEFluidObjectFunctions.PureComponentDerivatives.der_bubblePressure_Txi);
    end bubblePressure_Txi;

    function der_bubblePressure_Txi
      extends TILMedia.BaseClasses.PartialVLEFluidObjectFunction;
      input SI.Temperature T "Temperature";
      input SI.MassFraction[:] xi "Mass fractions of the first nc-1 components";
      input TILMedia.Internals.TILMediaExternalObject vleFluidPointer;
      input Real der_T "Temperature";
      input Real[:] der_xi "Mass fractions of the first nc-1 components";
      output Real der_p_bubble "Pressure at bubble point";
