...
model VLEFluid_ps
  ...
  extends TILMedia.BaseClasses.PartialVLEFluid_ps(vleFluidPointer=TILMedia.Internals.TILMediaExternalObject(
          "VLEFluid",
...
equation
  ...
  d =TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.ObjectFunctions.density_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  h =TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.ObjectFunctions.specificEnthalpy_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
  T =TILMedia.Internals.VLEFluid.AdditionalObjectFunctionsWithDerivatives.ObjectFunctions.temperature_psxi(
    p,
    s,
    xi,
    vleFluidPointer);
